...
const checkWishlistStatus = async () => {
  try {
    ...
    isInWishlist.value = wishlist.some(
      (g: any) => g._id === game.value._id || g.id === game.value._id
    );
  } catch (e) {
...
const toggleWishlist = async () => {
  try {
    ...
    alertStore.showAlert({
      title: 'Erreur',
      message: e.response?.data?.message || 'Erreur wishlist',
      type: 'error',
    });
  }
};
      ...
      <div class="hero-section">
        ...
        <div class="hero-content">
          <div class="game-title-card glass-panel">
            <span v-if="game.latestVersion" class="version-badge"
              >DEV {{ game.latestVersion }}</span
            >
          ...
          <div class="sidebar-sticky">
            ...
            <div class="action-card glass-panel">
              ...
              <div class="action-buttons">
                <button
                  v-if="!userOwnsGame && game.price > 0"
                  @click="purchaseGame"
                ...
                <div v-else-if="userOwnsGame" class="install-flow">
                  <div
                    v-if="installingGameId === (game.slug || game.gameId)"
                    class="install-status"
                  >
                    <div class="progress-header">
                      <span>{{
                        installProgress.type === 'download' ? 'Téléchargement' : 'Installation'
                      }}</span>
                  ...
                  <div v-else class="game-actions">
                    ...
                    <button v-if="isInstalled" @click="uninstallGame" class="btn-text btn-sm">
                      Désinstaller
                    </button>
                  </div>
                </div>
                ...
                <button
                  v-else-if="!userOwnsGame && game.price === 0"
                  @click="purchaseGame"
                  :disabled="isPurchasing"
                  class="btn-primary btn-block btn-glow"
                >
            ...
            <div class="meta-card glass-panel">
              ...
              <div class="meta-row">
                ...
                <span class="meta-value">{{
                  game.isMultiplayer ? `1-${game.maxPlayers}` : 'Solo'
                }}</span>
              </div>
              <div class="meta-row">
