...
| **Property:**             |                | **Function:**                                                                                                                                                                                                                   |
| :------------------------ | :------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **FocusTarget**           |                | The camera's focus distance will be set to the distance from camera to the selected target. The Focus Offset field will then modify that distance.                                                                              |
...
| **Custom Target**         |                | The target to use if Focus Target is set to _CustomTarget_.                                                                                                                                                                     |
| **Focus Depth Offset**    |                | Offsets the sharpest point away in depth from the focus target location.                                                                                                                                                        |
| **Damping**               |                | The value corresponds approximately to the time the focus will take to adjust to the new value.                                                                                                                                 |
| **Auto Detection Radius** |                | HDRP-only: Radius of the AutoFocus sensor in the center of the screen, used when _Focus Target_ is set to _ScreenCenter_. A value of 1 would fill the screen. It's recommended to keep this quite small. Default value is 0.02. |
