...
| --------------------- | ------------------------------------------------------------------------------ |
| **Auto Smooth**       | If checked, the spline will be automatically smoothed whenever it is modified. |
| **Smooth Spline Now** | Invokes the spline smoothing function to adjust the knot tangents.             |
