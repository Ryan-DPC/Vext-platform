...
| --------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Index Unit**  |         | Defines how to interpret the _Index_ field for each data point. _Knot_ is the recommended value because it remains robust if the spline points change. |
| **Easing**      |         | When enabled, roll value will ease in and out of the data point values. Otherwise, interpolation is linear.                                            |
| **Data Points** |         | The list of Roll points on the spline. At these postions on the spline, it will take on the specified roll value.                                      |
