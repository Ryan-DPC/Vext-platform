...
1. In the Unity menu, choose **GameObject > Cinemachine > Target Group Camera**. <br/>Unity adds a new CinemachineCamera and Target Group to the Scene. The **Follow** and **Look At** targets in the CinemachineCamera refer to the new Target Group.
